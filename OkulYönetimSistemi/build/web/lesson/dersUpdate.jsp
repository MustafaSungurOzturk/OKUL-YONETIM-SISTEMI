...
<body>
        ...
        <div class="col-sm-4">
            <form method="POST" align="left" action="dersData.jsp" class="box">
                ...
                pst = con.prepareStatement("select * from lesson where id = ?");
                pst.setString(1, id);
                rs = pst.executeQuery();
                ...
                %>
                    ...
                    <input type="text" id="lessonname" name="lessonname" placeholder="Ders Adi" value="<%= rs.getString("lessonname") %>" required>
                    <label>Ders Süresi:</label>>
                    <input type="text" id="lessontime" name="lessontime" placeholder="Ders Süresi" value="<%= rs.getString("lessontime") %>" required>
