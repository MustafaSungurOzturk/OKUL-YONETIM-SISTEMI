...
<body>
        ...
        <div>
            <form method="POST" align="left" action="notData.jsp" class="box">
                ...
                pst = con.prepareStatement("select * from lessonnotes where id = ?");
                pst.setString(1, id);
                rs = pst.executeQuery();
                ...
                %>
                    ...
                    <input type="text" id="id" name="id" placeholder="Not ID" value="<%= rs.getString("id") %>" required>
                    ...
                    <input type="text" id="notes" name="notes" placeholder="Notu" value="<%= rs.getString("notes") %>" required>
